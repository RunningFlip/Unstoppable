...
public class WaitJob : Job
{
    ...
    public WaitJob(MultiDelegate _jobCall, float _timeToWait, JobUpdateType _jobUpdateType = JobUpdateType.Update, bool _destroyOnLoad = true) : base(_jobUpdateType, _destroyOnLoad)
    {
