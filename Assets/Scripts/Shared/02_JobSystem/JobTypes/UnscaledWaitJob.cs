...
public class UnscaledWaitJob : Job
{
    ...
    public UnscaledWaitJob(MultiDelegate _jobCall, float _timeToWait, JobUpdateType _jobUpdateType = JobUpdateType.Update, bool _destroyOnLoad = true) : base(_jobUpdateType, _destroyOnLoad)
    {
