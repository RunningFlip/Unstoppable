...
public class DefaultJob : Job
{
    ...
    public DefaultJob(MultiDelegate _jobCall, JobUpdateType _jobUpdateType = JobUpdateType.Update, bool _destroyOnLoad = true) : base(_jobUpdateType, _destroyOnLoad)
    {     
