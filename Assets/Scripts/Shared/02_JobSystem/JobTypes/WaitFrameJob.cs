...
public class WaitFrameJob : Job
{
    ...
    public WaitFrameJob(MultiDelegate _jobCall, int _frames = 1, JobUpdateType _jobUpdateType = JobUpdateType.Update, bool _destroyOnLoad = true) : base(_jobUpdateType, _destroyOnLoad)
    {
